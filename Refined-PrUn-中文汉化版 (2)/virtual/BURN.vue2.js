                ...
                [
                  createVNode(
                    ...
                    },
                    {
                      default: withCtx(() => [
                        createTextVNode(
                          toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.red')),
                          1,
                        ),
                      ]),
                      _: 1,
                  ...
                  createVNode(
                    ...
                    },
                    {
                      default: withCtx(() => [
                        createTextVNode(
                          toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.yellow')),
                          1,
                        ),
                      ]),
                      _: 1,
                  ...
                  createVNode(
                    ...
                    },
                    {
                      default: withCtx(() => [
                        createTextVNode(
                          toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.green')),
                          1,
                        ),
                      ]),
                      _: 1,
                  ...
                  createVNode(
                    ...
                    },
                    {
                      default: withCtx(() => [
                        createTextVNode(
                          toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.inf')),
                          1,
                        ),
                      ]),
                      _: 1,
                ...
                [
                  createVNode(
                    ...
                    },
                    {
                      default: withCtx(() => [
                        createTextVNode(
                          toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.quickPurchase')),
                          1,
                        ),
                      ]),
                      _: 1,
                ...
                createBaseVNode('thead', null, [
                  createBaseVNode('tr', null, [
                    ...
                    createBaseVNode(
                      'th',
                      null,
                      toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.inv')),
                      1,
                    ),
                    createBaseVNode('th', null, [
                      createVNode(InlineFlex, null, {
                        default: withCtx(() => [
                          createTextVNode(
                            toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.burn')) + ' ',
                            1,
                          ),
                          createVNode(
                            _sfc_main$3,
                            {
                              position: 'bottom',
                              tooltip: ('t' in _ctx ? _ctx.t : unref(t))('burn.burnTooltip'),
                            },
                            null,
                            8,
                            ['tooltip'],
                    ...
                    createBaseVNode('th', null, [
                      createVNode(InlineFlex, null, {
                        default: withCtx(() => [
                          createTextVNode(
                            toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.need')) + ' ',
                            1,
                          ),
                          createVNode(
                            _sfc_main$3,
                            {
                              position: 'bottom',
                              tooltip: ('t' in _ctx ? _ctx.t : unref(t))('burn.needTooltip'),
                            },
                            null,
                            8,
                            ['tooltip'],
                    ...
                    createBaseVNode(
                      'th',
                      null,
                      toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.days')),
                      1,
                    ),
                    createBaseVNode(
                      'th',
                      null,
                      toDisplayString(('t' in _ctx ? _ctx.t : unref(t))('burn.cmd')),
                      1,
                    ),
                  ]),
                ]),
